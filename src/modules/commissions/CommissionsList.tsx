    ...
    <section className="max-w-6xl mx-auto mt-8 space-y-6">
      <header className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            className="bg-[#070707]/80 border border-[#00E8FF]/50 text-[#E4FCFF] px-3 py-2 rounded-lg focus:ring-2 focus:ring-[#00E8FF]"
            value={selectedMonth}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <SummaryCard label="Total comisiones" value={totals.total} color="text-[#00E8FF]" />
        <SummaryCard label="Pendientes" value={totals.pending} color="text-yellow-300" />
        <SummaryCard label="Pagadas" value={totals.paid} color="text-emerald-300" />
      </div>

      <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl overflow-hidden">
        <table className="w-full text-sm text-left text-[#E4FCFF]">
          <thead className="bg-[#070707]/80 border-b border-white/10 text-[#E4FCFF]">
            <tr>
                    ...
                    <td className="px-4 py-3 text-right">
                      {isPending && (
                        <button
                          ...
                          className="px-3 py-1 text-xs rounded-lg border border-[#00E8FF]/50 text-[#E4FCFF] hover:bg-[#00E8FF]/20 transition"
                        >
                          Marcar pagada
                        </button>
                      )}
